...
description: |
  An example of time response correction using Argo data.
author:
...
![oxygen and delta oxygen profiles](correcting-oxygen-response-time-error-on-an-argo-float_files\correcting-argo-oxygen-response-time_15_2.svg)
