...
To date we have deployed `nrow(py$recent_table)` floats in 2024: `nrow(py$recent_table[py$recent_table$Detail == 'ARVOR_SBE'])` ARVOR-SBE, `nrow(py$recent_table[py$recent_table$Detail == 'ARVOR_RBR'])` ARVOR-RBR, `nrow(py$recent_table[py$recent_table$Detail == 'ARVOR+DO'])` ARVOR+DO, `nrow(py$recent_table[py$recent_table$Detail == 'ARVOR_D'])` Deep ARVOR+DO,, `nrow(py$recent_table[py$recent_table$Detail == 'PROVOR_CTS4'])+nrow(py$recent_table[py$recent_table$Detail == 'PROVOR_CTS4+SUNA'])` PROVOR CTS4, and `nrow(py$recent_table[py$recent_table$Detail == 'PROVOR_CTS5'])` PROVOR CTS5.
