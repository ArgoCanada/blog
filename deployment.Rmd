...
To date we have deployed `r nrow(py$recent_table)` floats in 2024: `r nrow(py$recent_table[py$recent_table$Detail == 'ARVOR_SBE'])` ARVOR-SBE, `r nrow(py$recent_table[py$recent_table$Detail == 'ARVOR_RBR'])` ARVOR-RBR, `r nrow(py$recent_table[py$recent_table$Detail == 'ARVOR+DO'])` ARVOR+DO, `r nrow(py$recent_table[py$recent_table$Detail == 'ARVOR_D'])` Deep ARVOR+DO,, `r nrow(py$recent_table[py$recent_table$Detail == 'PROVOR_CTS4'])+nrow(py$recent_table[py$recent_table$Detail == 'PROVOR_CTS4+SUNA'])` PROVOR CTS4, and `r nrow(py$recent_table[py$recent_table$Detail == 'PROVOR_CTS5'])` PROVOR CTS5.
