...
To date we have deployed `r py$nfloats` floats in 2024: `r py$n_sbe` ARVOR-SBE, `r py$n_rbr` ARVOR-RBR, `r py$n_do` ARVOR+DO, `r py$n_deep` Deep ARVOR+DO,, `r py$n_cts4` PROVOR CTS4, and `r py$n_cts5` PROVOR CTS5.
