...
To date we have deployed `py recent.shape[0]` floats in 2024: `py recent.loc[recent.Detail == 'ARVOR_SBE'].shape[0]` ARVOR-SBE, `py recent.loc[recent$Detail == 'ARVOR_RBR'].shape[0]` ARVOR-RBR, `py recent.loc[recent$Detail == 'ARVOR+DO'].shape[0]` ARVOR+DO, `py recent_table[recent$Detail == 'ARVOR_D'].shape[0]` Deep ARVOR+DO,, `py recent[py$recent$Detail == 'PROVOR_CTS4'].shape[0]+recent.loc[recent$Detail == 'PROVOR_CTS4+SUNA'].shape[0]` PROVOR CTS4, and `py recent.loc[recent$Detail == 'PROVOR_CTS5'].shape[0]` PROVOR CTS5.
