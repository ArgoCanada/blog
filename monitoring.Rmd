...
def bgc_type(index, wmo):
  for v in ['CHLA', 'BBP700', 'NITRATE', 'DOWNWELLING_IRRADIANCE', 'pH']:
    if v in index.loc[index.wmo == wmo].parameters:
      return 'BGC'
...
for ix, row in core_index.iterrows():
  ...
  for ax, v in zip(axes, ['TEMP', 'PSAL']):
    ...
    sns.scatterplot(
      ...
      palette=['green', 'yellow', 'orange', 'red', 'blue', 'blue', 'blue', 'blue', 'blue'], 
